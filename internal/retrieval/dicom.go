...
func OpenDICOM(r io.Reader, p Permit, study string, limit int64) (*DICOMStream, error) {
	...
	if d.last != 0x0020000d || d.values[0x0020000d] != study || d.values[0x00100020] != p.Patient.ID || d.values[0x00100021] != p.Patient.Issuer || d.values[0x00080050] != p.Examination.Accession || d.values[0x00400031] != p.Examination.Issuer {
